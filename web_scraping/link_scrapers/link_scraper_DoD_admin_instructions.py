...
## Set-up
parent_url = "https://www.esd.whs.mil/Directives/issuances/admin_inst/"
...
hrefs = []
titles = []
for i in range(1, 5000+1): #if the page has more than 5000 documents, I will miss them...

    title_xpath = '//*[@id="dnn_ctr6470_Default_List_grdData"]/tbody/tr[' + str(i) + ']/td[3]'

    try:
        xpath = '//*[@id="dnn_ctr6470_Default_List_grdData"]/tbody/tr[' + str(i) + ']/td[1]/a'
        ...
        try:
            xpath = '//*[@id="dnn_ctr6470_Default_List_grdData"]/tbody/tr[' + str(i) + ']/td[1]/p/a'
            element = driver.find_element_by_xpath(xpath)
            hrefs.append(element.get_attribute('href'))
            titles.append(driver.find_element_by_xpath(title_xpath).text)
...
df.to_csv('logs/DoD_admin_instructions.csv', index=False)
