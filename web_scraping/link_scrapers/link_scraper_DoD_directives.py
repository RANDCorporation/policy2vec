...
## Set-up
parent_url = "https://www.esd.whs.mil/Directives/issuances/dodd/"
...
for i in range(1, 1000+1):
    ...
    title_xpath = '//*[@id="dnn_ctr6575_Default_List_grdData"]/tbody/tr[' + str(i) + ']/td[3]'

    try:
        xpath = '//*[@id="dnn_ctr6575_Default_List_grdData"]/tbody/tr[' + str(i) + ']/td[1]/a'
        ...
        try:
            xpath = '//*[@id="dnn_ctr6575_Default_List_grdData"]/tbody/tr[' + str(i) + ']/td[1]/p/a'
            element = driver.find_element_by_xpath(xpath)
            hrefs.append(element.get_attribute('href'))
            titles.append(driver.find_element_by_xpath(title_xpath).text)
...
if not os.path.exists('logs'):
    os.makedirs('logs')
source_link = ['https://www.esd.whs.mil/Directives/issuances/dodd/']*len(hrefs)
...
df.to_csv('logs/DoD_directives.csv', index=False)
