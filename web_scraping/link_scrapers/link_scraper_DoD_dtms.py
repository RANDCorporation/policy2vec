...
## Set-up
parent_url = "https://www.esd.whs.mil/Directives/issuances/dtm/"
...
for i in range(1, 500+1):
    ...
    href = None
    title_xpath = '//*[@id="dnn_ctr6342_Default_List_grdData"]/tbody/tr[' + str(i) + ']/td[3]'

    ## first try
    try:
        xpath = '//*[@id="dnn_ctr6342_Default_List_grdData"]/tbody/tr[' + str(i) + ']/td[1]/a'
    ...
    ## second try
        ...
        try:
            xpath = '//*[@id="dnn_ctr6342_Default_List_grdData"]/tbody/tr[' + str(i) + ']/td[1]/p/a'
            element = driver.find_element_by_xpath(xpath)
            href = element.get_attribute('href')
