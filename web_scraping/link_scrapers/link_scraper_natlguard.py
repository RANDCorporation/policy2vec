...
#Air-Force
get_internet = driver.find_element_by_xpath('//*[@id="mvcContainer-449"]/div[2]/div[1]/div[1]/ul/li[2]/a')
get_internet.click()
time.sleep(3)
#Air National Guard
get_internet = driver.find_element_by_xpath('//*[@id="cat-16"]/div/ul/li/a')
get_internet.click()
time.sleep(3)
# All-Pubs
...
df.to_csv('logs/AF_epubs_natlguard.csv', index=False)


## Save the links
#with open('links/AF_epubs_natlguard.txt', 'w') as f:
#    for item in hrefs:
#        f.write("%s\n" % item)
## close the session
driver.quit()
