...
## Get the AF Department-Level pubs
#Air-Force
get_internet = driver.find_element_by_xpath('//*[@id="mvcContainer-449"]/div[2]/div[1]/div[1]/ul/li[1]/a')
get_internet.click()
time.sleep(3)
#Departmental
get_internet = driver.find_element_by_xpath('//*[@id="cat-1"]/div/ul/li/a')
get_internet.click()
time.sleep(3)
# All-Pubs
...
s = driver.find_element_by_xpath('//*[@id="data_paginate"]/span/a[6]').text
print(s)
#s = s[s.index('of'):]
...
## Note to self:
## I'm not sure what happened - the website must have changed since I first wrote the code,
## but the num_pages assignment is incorrect.
num_pages = num_docs
...
df.to_csv('logs/AF_epubs_departmental.csv', index=False)


### Save the links
#with open('links/AF_epubs_departmental.txt', 'w') as f:
#    for item in hrefs:
#        f.write("%s\n" % item)
## close the session
driver.quit()
